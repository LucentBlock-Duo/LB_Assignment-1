...
public class UserPreferenceService {
    ...
    public List<UserPreference> fetchPreferencesByUser(User user) {
        return repository.findAllByUser(user);
    }

    public List<UserPreference> fetchPreferencesByCarManufacturer(CarManufacturer carManufacturer) {
