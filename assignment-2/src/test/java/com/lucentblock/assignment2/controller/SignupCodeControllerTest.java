...
public class SignupCodeControllerTest {
    ...
    @Test
    @WithMockUser(username = "alreadyVerified@test.com", authorities = {"ROLE_USER"})
    ...
    void generateSignupCodeWithUserWhoVerifiedEmail() throws Exception {
        ...
        given(signupCodeService.generateSignupCode(currentUser))
                .willThrow(new AlreadyVerifiedUserException(currentUser));
        ...
        this.mockMvc.perform(post("/api/email-verification"))
                ...
                .andExpect(jsonPath("user_email").value(currentUser));
    }

    @Test
    @WithMockUser(username = "DoesNotExist@test.com", authorities = {"ROLE_USER"})
    ...
    void verifySignupCodeWithUserWhoIsNotVerifiedAndSignupCodeMatched() throws Exception {
        // given
        String currentUser = SecurityContextHolder.getContext().getAuthentication().getName();
        given(signupCodeService.verifySignupCode(currentUser, "correctCode"))
    ...
    void verifySignupCodeWithUserWhoIsNotVerifiedAndSignupCodeDoesNotMatched() throws Exception {
        // given
        String currentUser = SecurityContextHolder.getContext().getAuthentication().getName();
        given(signupCodeService.verifySignupCode(currentUser, "incorrectCode"))
    ...
    void verifySignupCodeWithUserWhoIsAlreadyVerified() throws Exception {
        // given
        String currentUser = SecurityContextHolder.getContext().getAuthentication().getName();
        given(signupCodeService.verifySignupCode(currentUser, "code"))
